...
renderToStaticMarkup:function(a){a=new ra(a,!0);try{return a.read(Infinity)}finally{a.destroy()}},renderToNodeStream:function(){throw q(Error(207));},renderToStaticNodeStream:function(){throw q(Error(208));},version:"16.9.0-rc.0"};k=(B={default:k},k)||B;return k.default||k});
