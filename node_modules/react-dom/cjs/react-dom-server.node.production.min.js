...
return b}(aa.Readable),Ya={renderToString:function(a){a=new Va(a,!1);try{return a.read(Infinity)}finally{a.destroy()}},renderToStaticMarkup:function(a){a=new Va(a,!0);try{return a.read(Infinity)}finally{a.destroy()}},renderToNodeStream:function(a){return new Xa(a,!1)},renderToStaticNodeStream:function(a){return new Xa(a,!0)},version:"16.9.0-rc.0"},Za={default:Ya},$a=Za&&Ya||Za;module.exports=$a.default||$a;
